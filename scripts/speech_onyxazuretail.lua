...
return {
	ACTIONFAIL =
	{
		SHAVE =
		{
			AWAKEBEEFALO = "Dangerous, Lets wait until Nightfall.",
		...
		STORE =
		{
			...
			INUSE = "They seem busy, I should wait.",
		},
		RUMMAGE =
		{	
        ...
        GIVE =
        {
            ...
            BUSY = "They seem busy, I should wait.",
        },
        GIVETOPLAYER = 
        {
        	FULL = "Pockets full, Hey!",
            DEAD = "Maybe I'll just hold on to this.",
            SLEEPING = "Too unconcious to care.",
            BUSY = "They seem busy, I should wait.",
    	},
	...
	ANNOUNCE_DEERCLOPS = "Uh oh.. DeerClops incoming!",
	ANNOUNCE_DUSK = "The shadows, They becon.",
	ANNOUNCE_EAT =
	{
		GENERIC = "Yum!",
	...
	ANNOUNCE_ENTER_DARK = "Back shadows!",
	ANNOUNCE_ENTER_LIGHT = "Glorious light.",
	ANNOUNCE_FREEDOM = "I'm free! I'm finally free!",
	ANNOUNCE_HIGHRESEARCH = "I feel so smart now!",
	ANNOUNCE_HOUNDS = "They hunt in packs, Prepare.",
	ANNOUNCE_HUNGRY = "Grr.. Rumbly Tumbly.",
	...
	ANNOUNCE_INV_FULL = "Too full, empty some pockets!",
	...
	ANNOUNCE_NOSLEEPONFIRE = "Maybe, but lets not. For safety.",
	...
	ANNOUNCE_QUAKE = "Was that my stomach?",
	ANNOUNCE_RESEARCH = "Never stop learning!",
	ANNOUNCE_SHELTER = "Nature is good for something.",
	ANNOUNCE_THORNS = "Ow!",
	ANNOUNCE_BURNT = "Tsk, Hot.",
	...
	ANNOUNCE_WORMHOLE = "And there goes my mind.",
	...
	BATTLECRY =
	{
		GENERIC = "Lets toast it!",
		PIG = "Oh look, meat to sear!",
		PREY = "I will destroy you!",
		SPIDER = "I'm going to stomp you dead!",
		SPIDER_WARRIOR = "Crispy spiders, Coming right up!",
	},
	COMBAT_QUIT =
	{
